...
const DrawerLinkButtonGroup = () => {
  ...
  return (
    <ul
      className={cn("flex flex-col gap-4 text-gray-950 ", {
        "text-white": currentTheme === "dark"
      })}
    >
      <li>
        <Link href="https://blog.csdn.net/csdn1940879828" className="py-4">
          <svg
            role="img"
            viewBox="1 3 22 18"
      ...
      <li>
        <Link href="https://github.com/1940879828/taroblog" className="py-4">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <ThemeChanger showText size={20} className="py-4 justify-start -ml-1" />
      </li>
    </ul>
  )
}

export default DrawerLinkButtonGroup
