...
const experiments = [
  {
    ...
    watch: "右键查看网页源码，能看到数据已经渲染进 HTML；Network 里没有额外的数据请求。",
  },
  {
  ...
  },
  {
    ...
    watch: "对比两个区域：服务端直接读 window 会报错，客户端 useEffect 读则正常。",
  },
  {
    href: "/lab/rsc/hybrid",
    title: "混合树",
  ...
  },
  {
    ...
    title: "SWR 版瀑布流：加载更多",
    desc: "useSWRInfinite 实现滚动到底部加载下一页。",
    watch: "第一页 SSR；滚动到底触发 /api/waterfall-items?page=N 请求并追加。",
  },
];
