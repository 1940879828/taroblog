...
export default async function NotFound() {
  return (
    <div className="h-[calc(100dvh-65px)] w-screen flex items-center not-fount container mx-auto">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md flex flex-col gap-6">
          <div className="text-5xl font-bold text-base-content">404</div>
          <p className="text-2xl md:text-3xl leading-normal text-base-content">
